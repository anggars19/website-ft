<?php 
include ("koneksi.php");
$sql    = $db->QUERY ("SELECT `nama_prodi`,`header`, `id_prodi`, `id_fakultas` FROM `header` WHERE `id_prodi`='$id_prodi' AND `id_fakultas`='$id_fakultas' ");
...
<style type="text/css">
	...
	.footer {
    background-color:<?php echo $template['color_footer'];?>;	
	}
