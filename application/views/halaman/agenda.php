...
<div id="content">
 <div class="container">
  <div class="row blog-post-page">
   ...
   <div class="col-md-12 ">
	<table class="table table-striped" width="100%" style="margin-top:14px;">
	<tbody>
		<tr>
			<td width="8%">Penyelenggara</td>
			<td width="1%">:</td>		
			<td width="50%"><?php echo $tampil['penyelenggara']?></td>
			<td rowspan="5" width="40%">
          <a class="lightbox img-responsive center-block" title="<?php echo $tampil['judul']?>"  alt="<?php echo $tampil['judul'];?>" href="<?php if($tampil['gambar']!=''){ echo $tampil['gambar'];}else{ echo 'http://pics.unipma.ac.id/no_image.png'; }?>" data-lightbox-gallery="gallery1">
            <img alt="<?php echo $tampil['judul'];?>" style="margin-left:50%; margin-right:50%;width=40px;height:200px;" class= " img-responsive center-block"src="<?php if($tampil['gambar']!=''){ echo $tampil['gambar'];}else{ echo 'http://pics.unipma.ac.id/no_image.png'; }?>" 
			>
          </a>		  
			</td>
		</tr>
