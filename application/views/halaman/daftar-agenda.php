...
<table width="100%">
			        <th width="5%" ><p align="center" style="font-size:16px">NO</p></th>
                    		<th width="40%"><p align="center" style="font-size:16px">AGENDA</p></th>
...
<ul class="pagination" >
        ...
        ?>
         <li><a href="<?php echo base_url('daftar_agenda?page=1')?>">First</a></li>
          <li><a href="<?php echo base_url('daftar_agenda?page=')?><?php echo $link_prev; ?>">&laquo;</a></li>
        <?php
        }
        ?>
        <!-- LINK NUMBER -->
        ...
        ?>
         <li<?php echo $link_active; ?>><a href="<?php echo base_url('daftar_agenda?page=')?><?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php
        }
        ?>    
        <!-- LINK NEXT AND LAST -->
        ...
        ?>
           <li><a href="<?php echo base_url('daftar_agenda?page=')?><?php echo $link_next; ?>">&raquo;</a></li>
          <li><a href="<?php echo base_url('daftar_agenda?page=')?><?php echo $jumlah_page; ?>">Last</a></li>
        <?php
        }
        ?>
      </ul>			
